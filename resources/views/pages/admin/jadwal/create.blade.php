                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="mapel_id" id="mapel_id" class="form-control @error('mapel_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $mpl->id }}" {{ old('mapel_id') == $mpl->id ? 'selected' : '' }}>{{ $mpl->nama }}</option>
                                    @endforeach
                                </select>
                                @error('mapel_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="ruang_id" id="ruang_id" class="form-control @error('ruang_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $rng->id }}" {{ old('ruang_id') == $rng->id ? 'selected' : '' }}>{{ $rng->nama }}</option>
                                    @endforeach
                                </select>
                                @error('ruang_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="guru_id" id="guru_id" class="form-control @error('guru_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($guru as $gr)
                                    <option value="{{ $gr->id }}" {{ old('guru_id') == $gr->id ? 'selected' : '' }}>{{ $gr->nama }}</option>
                                    @endforeach
                                </select>
                                @error('guru_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <select name="jam_pelajaran_id" id="jam_pelajaran_id" class="form-control @error('jam_pelajaran_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $jam->id }}" {{ old('jam_pelajaran_id') == $jam->id ? 'selected' : '' }}>{{ $jam->nama }} ({{ $jam->jam_mulai }} - {{ $jam->jam_selesai }})</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="hari_id" id="hari_id" class="form-control @error('hari_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($hari as $hr)
                                    <option value="{{ $hr->id }}" {{ old('hari_id') == $hr->id ? 'selected' : '' }}>{{ $hr->nama }}</option>
                                    @endforeach
                                </select>
                                @error('hari_id')
                                <div class="invalid-feedback">{{ $message }}</div>
