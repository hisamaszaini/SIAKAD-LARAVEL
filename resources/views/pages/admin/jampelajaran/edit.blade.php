        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Jam Pelajaran</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('jampelajaran.update', $jamPelajaran->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="time" name="jam_mulai" id="jam_mulai"
                                    ...
                                    value="{{ old('jam_mulai', date('H:i', strtotime($jamPelajaran->jam_mulai))) }}" required step="300"> <!-- Lompatan 5 menit -->
                                @error('jam_mulai')
                                <div class="invalid-feedback"> {{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <input type="time" name="jam_selesai" id="jam_selesai"
                                    ...
                                    value="{{ old('jam_selesai', date('H:i', strtotime($jamPelajaran->jam_selesai))) }}" required step="300"> <!-- Lompatan 5 menit -->
                                @error('jam_selesai')
                                <div class="invalid-feedback"> {{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6 col-12">
                                ...
                                <select name="urutan" id="urutan"
                                    ...
                                    @for ($i = 1; $i <= 14; $i++)
                                        <option value="{{ $i }}" {{ old('urutan', $jamPelajaran->urutan) == $i ? 'selected' : '' }}>
                                            {{ $i }}
                                        </option>
                                    @endfor
                                </select>
