                    ...
                    <tbody>
                        ...
                        <tr id="sid{{ $data->id }}">
                            ...
                            <td class="text-center min-row">
                                ...
                                <form action="{{ route('penagihan.create', $data->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    <button type="submit" class="btn btn-primary btn-sm" title="Buat Penagihan">Buat Penagihan</button>
                                </form>
                            </td>
                        </tr>
                        @empty
